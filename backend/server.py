...
# Email setup (for legacy code that may still reference these)
...
# ==================== VIDEO TRANSCRIPTION ====================
# MOVED TO: /app/backend/routes/youtube.py
# Endpoints: /video/transcript/{video_id}, /video/transcript/{video_id}/cached
# ==================== END VIDEO TRANSCRIPTION ====================

# Video models (also defined in models/schemas.py but kept here for backward compatibility)
...
async def search_images(
    ...
    try:
        ...
        pixabay_key = os.environ.get('PIXABAY_API_KEY', '')  # User must provide their own key from pixabay.com/api/docs/
