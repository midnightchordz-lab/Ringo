    ...
    <div className="flex h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800">
        ...
        <div className="p-3 border-t border-slate-100 dark:border-slate-800 space-y-1">
          ...
          {/* Settings */}
          <Link to="/settings">
            <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
