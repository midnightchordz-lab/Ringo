  ...
  return (
    <div className="p-6 lg:p-8 pb-24 lg:pb-8 bg-neutral-50 dark:bg-neutral-950 min-h-screen transition-colors duration-300">
      ...
      <div className="mb-8">
        ...
        >
          <div>
            <h1 className="text-3xl lg:text-4xl font-bold text-neutral-900 dark:text-neutral-100 mb-2" style={{ fontFamily: 'Outfit, sans-serif' }}>
              Welcome back, <span className="text-gradient">{user.full_name?.split(' ')[0] || 'Creator'}</span>! 👋
            </h1>
            <p className="text-neutral-500 dark:text-neutral-400 text-lg">Here's what's happening with your content today.</p>
          </div>
          <div className="flex gap-3">
            {stats?.total_videos_discovered > 0 && (
              <Button
                ...
                className="bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/50 font-semibold rounded-xl px-5 py-2.5 border border-red-200 dark:border-red-800"
              >
